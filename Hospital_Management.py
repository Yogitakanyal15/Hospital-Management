...
while True:
    ...
    mysql=mysql.connector.connect(host="localhost",user="root",passwd="12345y.k")
    ...
    while(True):
        ...
        #PRINTING THE SINGIN OPTION AGAIN TO THE USER AFTER REGISTRATION
                ...
                print("Please first get yourself registered if you haven't!!")

                re=input("Enter if you have registered??(Y/N):")
                if re=='N':
                            ...
                            if a==1:
                                ...
                                #IF USER WANTS TO ENTER DETAILS
                                    ...
                                    if c==1:
                                      ...
                                      mycursor.execute("insert into doctor_details values('{}','{}',{},'{}','{}',{},{})".format(name,spe,age,add,cont,fees,ms))
                                      mysql.commit()
                                    ...
                                    #for entering nurse details
                                      ...
                                      mycursor.execute("insert into nurse_details values('{}','{}','{}','{}',{})".format(name,age,add,cont,ms))
                                      mysql.commit()
                                      print("SUCCESSFULLY ADDED")
                                  ...
                                  #ASKING THE DETAILS
                                      ...
                                      ms=int(input("ENTER MONTHLY_SALARY:"))
                                      #INSERTING VALUES ENTERED TO THE TABLE
                                      mycursor.execute("insert into other_workers_details values('{}','{}','{}','{}',{})".format(name,age,add,cont,ms))
                                      mysql.commit()
                                      print("SUCCESSFULLY ADDED")
                                   ...
                                   if c==1:
                                       ...
                                       mycursor.execute("select * from doctor_details where name='{}'".format(name))
                                       row=mycursor.fetchall()
                                       print(row)
                                   ...
                                   #deleting nurse details
                                       ...
                                       name=input("ENTER NURSE NAME:")
                                       mycursor.execute("select * from nurse_details where name='{}'".format(name))
                                       row=mycursor.fetchall()
                                       print(row)
                                       p=input("you really wanna delete this data? (y/n):")
                                       if p=="y":
                                   ...
                                   #deleting other_workers details
                                       ...
                                       mycursor.execute("select * from other_workers_details where name='{}'".format(name))
                                       row=mycursor.fetchall()
                                       print(row)
                                       p=input("you really wanna delete this data? (y/n):")
                                       if p=="y":
                                ...
                                #adding new patient
                                    ...
                                    mycursor.execute ("insert into patient_details values('{}','{}','{}','{}','{}')".format(name,sex,age,address,contact))
                                    mysql.commit()
                                    mycursor.execute("select * from patient_details")
                                    for i in mycursor:
                                        v=list(i)
                                ...
                                #discharge process
                                    ...
                                    mycursor.execute("select * from patient_details where name='{}'".format(name))
                                    row=mycursor.fetchall()
                                    print(row)
    ...
    cho=input("Do you want to re-enter??(y/n):")
